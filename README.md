...
## recap.dev-example-serverless-project

**recap.dev-example-serverless-project** repository is an example of a Serverless and TypeScript project with detailed tracing.
